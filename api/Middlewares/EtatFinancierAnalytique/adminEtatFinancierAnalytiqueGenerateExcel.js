...
module.exports = {
    exportBilanAnalytiqueToExcel,
    exportCrnAnalytiqueToExcel,
    exportCrfAnalytiqueToExcel,
    exportTftiAnalytiqueToExcel,
    exportTftdAnalytiqueToExcel,
    exportEvcpAnalytiqueToExcel,
}