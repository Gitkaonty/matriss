...
const popupAjustRubriqueSADEbilan = ({ actionState, row, column, value, canModify, canAdd, canDelete, canView }) => {
    ...
    useEffect(() => {
        if (canView) {
            setListAjust(row.ajustsSAD.filter(item => item.nature === nature));
        }
    }, [row]);
                    ...
                    >
                        ...
                        >
                            ...
                            <Tooltip title="Sauvegarder les modifications">
                                <span>
                                    <IconButton
                                        onClick={(!canAdd && !canModify) || handleSaveClick(selectedRowId)}
...
export default popupAjustRubriqueSADEbilan;
