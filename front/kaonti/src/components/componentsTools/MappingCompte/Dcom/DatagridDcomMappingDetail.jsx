...
const DatagridTableDpComMappingDetail = ({ compteId, fileId, exerciceId, etatId, rubriqueId, nature, dComRubriqueData, canModify, canAdd, canDelete, canView }) => {
                ...
                <Stack direction={'row'} alignContent={'center'} alignItems={"center"} spacing={1} width={"100%"} height={"30px"}>
                    ...
                    <Stack width={"100%"} height={"30px"} spacing={0.5} alignItems={"left"} alignContent={"left"}
                        ...
                        <Tooltip title="Sauvegarder les modifications">
                            <span>
                                <IconButton
                                    disabled={(!canModify && !canAdd) || disableSaveBouton}
                                    variant="contained"
...
export default DatagridTableDpComMappingDetail;