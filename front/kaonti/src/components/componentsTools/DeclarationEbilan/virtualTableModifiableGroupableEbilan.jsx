...
const VirtualTableModifiableGroupableEbilan = ({columns, rows, deleteState, modifyState, state}) => {
    ...
    return (
      ...
      >
        <Table sx={{ width: 500, border: '1px solid #ddd',  }} aria-label="simple table">
          <TableHead 
            style={{
              ...
              <React.Fragment key={group.rubriques_poste} >
                ...
                >
                  ...
                  >
                    ...
                    {
                    group.rubriques_poste === "GOODWILL"
                      ? "GoodWill"
                      : group.rubriques_poste === "IMMO_CORP"
                        ? "Immobilisations corporelles"
                        : group.rubriques_poste === "IMMO_INCORP"
                          ? "Immobilisations incorporelles"
                          : group.rubriques_poste === "IMMO_ENCOURS" 
                ...
                >
                  ...
                  >
                      ...
                      {group.items.sort((a, b) => {return b.augmentation - a.augmentation;}).map((item) => (
                          ...
                          style={{padding: "10px", border:'none', width:'100%'}}
                        >
                        {columns.map((column) => {
                            ...
                            return (
                              ...
                              style={{ 
                                ...
                                //backgroundColor: column.id === 'taux' ? 'red' : 'green',
                                fontSize:15,
  ...
  export default VirtualTableModifiableGroupableEbilan;