...
export default function ParamDeviseComponent() {
    ...
    const fetchClassifications = () => {
        ...
        axios.get(`/sociales/classification/dossier/${Number(compteId)}/${Number(id)}`)
    ...
    const handleSaveClick = (ids) => () => {
        ...
        if (editRow) {
            ...
            axios.put(`/sociales/classification/${editRow.id}`, editRow)
            ...
            axios.post(`/sociales/classification`, newRow)
    ...
    const deleteRow = (value) => {
        ...
        if (value === true && selectedRowId.length === 1) {
            ...
            axios.delete(`/sociales/classification/${idToDelete}`)
        ...
        <Paper sx={{ elevation: "3", margin: "5px", padding: "10px", width: "98%", height: "110%" }}>
            ...
            <TabContext value={"1"}>
                ...
                <TabPanel value="1">
                    ...
                    <Typography variant='h6' sx={{ color: "black" }} align='left'>Paramétrages : Classifications</Typography>
