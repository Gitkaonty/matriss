...
export default function TableParamPlanComptableModeleT2Model({headCells, rows}) {
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.compteCharge}</TableCell>
                    <TableCell align="left">{row.compteTva}</TableCell>
                    <TableCell align="left">{row.nif}</TableCell>
                    <TableCell align="left">{row.statistique}</TableCell>
                    <TableCell align="left">{row.adresse}</TableCell>
                    <TableCell align="left">{row.motCle}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
