    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          A valider si on va supprimer cette partie
        </Typography>
      )}
...
export default function TableParamMappingT2Model({headCells, rows}) {
  ...
  return (
    <Box sx={{ width: '100%'}}>
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.filtre}</TableCell>
                    <TableCell align="left">{row.solde}</TableCell>
                    <TableCell align="left">{row.sensCalcul}</TableCell>
                    <TableCell align="left">{row.typeCalcul}</TableCell>
                    <TableCell align="left">{row.vide}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
      ...
      <Stack >
        <FormControlLabel style={{alignContent:"start"}}
          control={<Switch checked={dense} onChange={handleChangeDense} />}
          label="Réduire la hauteur des lignes"
        />
      </Stack>
