...
export default function TableSADModel({rows}) {
  return (
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead style={{backgroundColor:initial.tableHeaderBackgroundColor}}>
          <TableRow>
            ...
            <TableCell align="right" style={{width:"100px" , fontWeight:'bold'}}>Total imputation</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right">{row.totalImputation}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
