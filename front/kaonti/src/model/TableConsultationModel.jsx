...
export default function TableConsultationModel({headCells, rows}) {
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.lettrage}</TableCell>
                    <TableCell align="left">{row.analytique}</TableCell>
                    <TableCell align="left">{row.comm}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
